...
class CalendarSelection: UIViewController {
    ...
    @IBAction func applyDateSelection(_ sender: Any) {
            ...
            self.delegate?.didUpdatedDates(self.startDate, self.endDate, self.selectedDates.text ?? "All time")
...
//=========function to deal the selection range==============
//        else
...
//                        self.selectedDates.text = self.convertDateFormat(calendar.selectedDates.first!) + " to " + self.convertDateFormat(date)
//                        self.startDate = calendar.selectedDates.first!
//                        self.endDate = date
//                } else {
//                        self.selectedDates.text = self.convertDateFormat(date) + " to " + self.convertDateFormat(calendar.selectedDates.last!)
//                        self.startDate = date
//                        self.endDate = calendar.selectedDates.last!
//                }
//        }
...
//        }
//=========function to deal the selection range==============
            self.selectedDates.text = self.convertDateFormat(calendar.selectedDates.first!)
            isClear = true
    }
